...
sandbox workload templates, providers, services, policies, settings, and
inference routes belong to a workspace and are not visible to members of other
workspaces.
...
retrying deletion. OpenShell removes membership records and inference routes as
part of successful workspace deletion.
